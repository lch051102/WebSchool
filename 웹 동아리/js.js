...
toggleButton.addEventListener('click', () => {
    if (list.style.display === 'none') {
        ...
        function searchImage() {
            ...
            else if (searchValue === '보건실' || searchValue === '보건교무실' || searchValue === '보건 교무실' || searchValue === '성고충 상담실' ||
                    searchValue === '성고충상담실' || searchValue === '동관 1층' || searchValue === '동관1층') {
                // 동관 1층에 해당하는 이미지로 설정
                img.src = '학교지도_동관_1층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '기초간호임상실무실' || searchValue === '기초간호 임상 실무실' || searchValue === '기초 간호 임상 실무실' || searchValue === '보건간호교육실 ' ||
                    searchValue === '보건간호 교육실' || searchValue === '보건 간호 교육실' || searchValue === '동관2층' || searchValue === '동관 2층') {
                // 동관 2층에 해당하는 이미지로 설정
                img.src = '학교지도_동관_2층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '요양지원실' || searchValue === '요양 지원실' || searchValue === '간호의기초실 ' || searchValue === '간호의 기초실 ' ||
                    searchValue === '동관3층' || searchValue === '동관 3층') {
                // 동관 3층에 해당하는 이미지로 설정
                img.src = '학교지도_동관_3층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '메이커 스페이스' || searchValue === '메이커스페이스 ' || searchValue === '메이커 ' || searchValue === '메이커실' ||
                    searchValue === '동관4층' || searchValue === '동관 4층') {
                // 동관 4층에 해당하는 이미지로 설정
                img.src = '학교지도_동관_4층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '국어교과' || searchValue === '수학교과' || searchValue === '국어 교과' || searchValue === '수학 교과' ||
                    searchValue === '학생자치실' || searchValue === '학생 자치실' || searchValue === '방송실' || searchValue === '서관 1층' ||
                    searchValue === '서관1층' ) {
                // 서관 1층에 해당하는 이미지로 설정
                img.src = '학교지도_서관_1층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '2학년1반' || searchValue === '1학년1반' || searchValue === '1학년2반' || searchValue === '1학년3반' ||
                    searchValue === '2학년 1반' || searchValue === '1학년 1반' || searchValue === '1학년 2반' ||  searchValue === '1학년 3반' || 
                    searchValue === '2-1' || searchValue === '1-1' || searchValue === '1-2' || searchValue === '1-3' || 
                    searchValue === '서관 2층' || searchValue === '서관2층' ) {
                // 서관 2층에 해당하는 이미지로 설정
                img.src = '학교지도_서관_2층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '1-4' || searchValue === '1학년4반' || searchValue === '1학년5반' || searchValue === '1학년 4반' ||
                    searchValue === '1학년 5반' || searchValue === '1-5' || searchValue === '1학년부' || searchValue === '과학준비' || 
                    searchValue === '과학 준비' || searchValue === '과학실' || searchValue === '서관3층' || searchValue === '서관 3층' ) {
                // 서관 3층에 해당하는 이미지로 설정
                img.src = '학교지도_서관_3층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '1학년6반' || searchValue === '1학년7반' || searchValue === '1학년 6반' || searchValue === '1학년 7반' ||
                    searchValue === '1-6' || searchValue === '1-7' || searchValue === '학생부' || searchValue === '미술실 ' || 
                    searchValue === '서관 4층' || searchValue === '서관4층' ) {
                // 서관 4층에 해당하는 이미지로 설정
                img.src = '학교지도_서관_4층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
            ...
            else if (searchValue === '1학년8반' || searchValue === '1학년9반' || searchValue === '1학년10반' || searchValue === '1학년 8반' ||
                    searchValue === '1학년 9반' || searchValue === '1학년 10반' || searchValue === '1-8' || searchValue === '1-9' || 
                    searchValue === '1-10' || searchValue === '사회교과' || searchValue === '사회 교과' ||
                    searchValue === '서관 5층' || searchValue === '서관5층' ) {
                // 서관 5층에 해당하는 이미지로 설정
                img.src = '학교지도_서관_5층.jpg';
                img.style.width = '1150px'; // 이미지 크기 조절
                img.style.height = '800px';
                img.style.top = '50%'; // 이미지 위치 조정
                img.style.left = '50%';
